...
class getNonMemberShoppingControllerService extends Eccube_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.JXI8VUx'] ?? $container->load('get_ServiceLocator_JXI8VUxService'))->withContext('Eccube\\Controller\\NonMemberShoppingController', $container));
