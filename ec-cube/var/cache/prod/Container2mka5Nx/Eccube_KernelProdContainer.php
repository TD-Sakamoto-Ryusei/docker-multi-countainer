...
class Eccube_KernelProdContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $i = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [0 => (\dirname(__DIR__, 4).'/app/Plugin/Api42/Entity')]);
        $i->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $j = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [0 => (\dirname(__DIR__, 4).'/app/Plugin/Coupon42/Entity')]);
        $j->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $k = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [0 => (\dirname(__DIR__, 4).'/app/Plugin/MailMagazine42/Entity')]);
        $k->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $l = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [0 => (\dirname(__DIR__, 4).'/app/Plugin/ProductReview42/Entity')]);
        $l->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $m = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [0 => (\dirname(__DIR__, 4).'/app/Plugin/Recommend42/Entity')]);
        $m->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $n = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [0 => (\dirname(__DIR__, 4).'/app/Plugin/RelatedProduct42/Entity')]);
        $n->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $o = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [0 => (\dirname(__DIR__, 4).'/app/Plugin/Securitychecker42/Entity')]);
        $o->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $p = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [0 => (\dirname(__DIR__, 4).'/app/Plugin/SiteKit42/Entity')]);
        $p->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));

        $f->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [0 => (\dirname(__DIR__, 4).'/vendor/league/oauth2-server-bundle/src/Entity')]), 'League\\Bundle\\OAuth2ServerBundle\\Entity');
        ...
        $f->addDriver($i, 'Plugin\\Api42\\Entity');
        $f->addDriver($j, 'Plugin\\Coupon42\\Entity');
        $f->addDriver($k, 'Plugin\\MailMagazine42\\Entity');
        $f->addDriver($l, 'Plugin\\ProductReview42\\Entity');
        $f->addDriver($m, 'Plugin\\Recommend42\\Entity');
        $f->addDriver($n, 'Plugin\\RelatedProduct42\\Entity');
        $f->addDriver($o, 'Plugin\\Securitychecker42\\Entity');
        $f->addDriver($p, 'Plugin\\SiteKit42\\Entity');
    ...
    {
        return $this->services['liip_imagine.cache.resolver.default'] = new \Liip\ImagineBundle\Imagine\Cache\Resolver\WebPathResolver(($this->services['.container.private.filesystem'] ?? ($this->services['.container.private.filesystem'] = new \Symfony\Component\Filesystem\Filesystem())), ($this->privates['router.request_context'] ?? $this->getRouter_RequestContextService()), \dirname(__DIR__, 4), 'html/upload/cache');
    }
    ...
    protected function getSecurity_Firewall_MapService()
    {
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(($this->privates['.service_locator.YP.F1Xa'] ?? $this->get_ServiceLocator_YP_F1XaService()), new RewindableGenerator(function () {
            ...
            yield 'security.firewall.map.context.admin' => ($this->privates['.security.request_matcher.qov8T.N'] ?? ($this->privates['.security.request_matcher.qov8T.N'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/'.$this->getEnv('string:ECCUBE_ADMIN_ROUTE').'/')));
