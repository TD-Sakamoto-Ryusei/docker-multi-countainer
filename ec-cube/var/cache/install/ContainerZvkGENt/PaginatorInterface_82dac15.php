...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializerae3c7 && ($this->initializerae3c7->__invoke($valueHolderae812, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializerae3c7) || 1) && $this->valueHolderae812 = $valueHolderae812;
        if ($this->valueHolderae812 === $returnValue = $this->valueHolderae812->paginate($target, $page, $limit, $options)) {
            return $this;
        }
        return $returnValue;
    }
