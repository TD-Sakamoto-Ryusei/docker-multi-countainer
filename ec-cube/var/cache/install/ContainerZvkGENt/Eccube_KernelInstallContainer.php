...
class Eccube_KernelInstallContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $f = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => (\dirname(__DIR__, 4).'/app/Plugin/Coupon42/Entity')]);
        $f->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $g = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => (\dirname(__DIR__, 4).'/app/Plugin/MailMagazine42/Entity')]);
        $g->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $h = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => (\dirname(__DIR__, 4).'/app/Plugin/ProductReview42/Entity')]);
        $h->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $i = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => (\dirname(__DIR__, 4).'/app/Plugin/Recommend42/Entity')]);
        $i->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $j = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => (\dirname(__DIR__, 4).'/app/Plugin/RelatedProduct42/Entity')]);
        $j->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $k = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => (\dirname(__DIR__, 4).'/app/Plugin/Securitychecker42/Entity')]);
        $k->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $l = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => (\dirname(__DIR__, 4).'/app/Plugin/SiteKit42/Entity')]);
        $l->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));

        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => (\dirname(__DIR__, 4).'/vendor/league/oauth2-server-bundle/src/Entity')]), 'League\\Bundle\\OAuth2ServerBundle\\Entity');
        ...
        $b->addDriver($f, 'Plugin\\Coupon42\\Entity');
        $b->addDriver($g, 'Plugin\\MailMagazine42\\Entity');
        $b->addDriver($h, 'Plugin\\ProductReview42\\Entity');
        $b->addDriver($i, 'Plugin\\Recommend42\\Entity');
        $b->addDriver($j, 'Plugin\\RelatedProduct42\\Entity');
        $b->addDriver($k, 'Plugin\\Securitychecker42\\Entity');
        $b->addDriver($l, 'Plugin\\SiteKit42\\Entity');
    ...
    protected function getSecurity_Firewall_MapService()
    {
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(($this->privates['.service_locator.YP.F1Xa'] ?? $this->get_ServiceLocator_YP_F1XaService()), new RewindableGenerator(function () {
            ...
            yield 'security.firewall.map.context.admin' => ($this->privates['.security.request_matcher.lEaA85j'] ?? ($this->privates['.security.request_matcher.lEaA85j'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/'.$this->getEnv('string:ECCUBE_ADMIN_ROUTE').'/')));
